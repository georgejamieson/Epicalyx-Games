...
namespace EpicalyxGame.Views
{
    public class GamesController : Controller
    {
        ...
        public GamesController(EpicalyxGamesContextDb context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GameID,GameName,AgeRating,Genre,Publisher,ReleaseYear")] Game game)
        {
            if (id != game.GameID)
            {
                return NotFound();
